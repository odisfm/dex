...
export default function ShinyButton({isShiny, toggleShiny, bgColor}: {
    isShiny: boolean,
    toggleShiny: () => void,
    bgColor: string
}) {
    return (
        ...
        >
            <ShinyIcon
                className={`h-8 w-8 ${isShiny ? " fill-black group-hover:fill-white " : "fill-white group-hover:fill-black"}`}/>
        </button>
    )
}