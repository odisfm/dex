...
export default function DexButton({pdex, setDex, selected}: {pdex: PokeAPI.Pokedex, setDex: Dispatch<SetStateAction<PokeAPI.Pokedex | null>>, selected: boolean}): ReactElement {
